    ...
    <div class="container pt-5 user-profile">
        <div class="row content">
            ...
            <div class="col-lg-2 col-md-3 col-12 pt-4">
                <button type="button" class="btn btn-edit_profile" data-bs-toggle="modal" data-bs-target="#edit-ProfileModal">
                    Edit Profile
                </button>
        ...
        <div class="row container">
            <div class="col-2">
            <button type="button" class="btn btn-edit_profile" data-bs-toggle="modal" data-bs-target="#add-productModal">
                Add My Product
            </button>
            </div>
            <div class="col-3">
            <button type="button" class="btn btn-edit_profile" data-bs-toggle="modal" data-bs-target="#add-catalogueModal">
                Add My Catalogue
            </button>
            </div>
